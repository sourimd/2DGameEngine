...
public:
  ...
  void drawRotateAndScaled(Sint16 x, Sint16 y, double angle, float scaledFactor) const;

  void vanish(Sint16 x, Sint16 y, float scaledFactor) const;
  
  void drawLeft(Sint16 x, Sint16 y, double angle) const;
